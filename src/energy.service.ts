...
import { ChargeTask as FeChargeTask } from './shared-models/charge-task.model'
import { ChargeTaskSetting as BeChargeTask } from './energy-actions/charge-task'
import { differenceInDays } from 'date-fns'
import { OptionsWithTZ, format } from 'date-fns-tz'

@Injectable()
export class EnergyService {
  private _chargeTasks: BeChargeTask[]
